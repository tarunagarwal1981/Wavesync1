            ...
            <div key={company.id} className={styles.companyCard}>
              ...
              <div className={styles.companyDetails}>
                ...
                {company.address && (
                  <div className={styles.detailItem}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                      <path d="M21 10C21 17L12 23L3 10C3 6.13401 6.13401 3 10 3C13.866 3 17 6.13401 17 10C17 11.1046 17.8954 12 19 12C20.1046 12 21 11.1046 21 10Z" stroke="currentColor" strokeWidth="2"/>
