-- ============================================================================
-- TRAVEL MANAGEMENT - COMPLETE RESET AND SETUP
-- ============================================================================
-- This script completely removes and recreates the travel management system
-- WARNING: This will delete all existing travel data!
-- Use this if you're encountering persistent schema issues
...
-- ============================================================================
-- STEP 3: CREATE TRAVEL REQUESTS TABLE
-- ============================================================================
...
-- ============================================================================
-- STEP 4: CREATE FLIGHT BOOKINGS TABLE
-- ============================================================================
...
-- ============================================================================
-- STEP 5: CREATE ACCOMMODATIONS TABLE
-- ============================================================================
...
-- ============================================================================
-- STEP 6: CREATE TRAVEL DOCUMENTS TABLE
-- ============================================================================
...
-- ============================================================================
-- STEP 7: CREATE TRAVEL EXPENSES TABLE
-- ============================================================================
...
CREATE INDEX idx_travel_requests_type ON travel_requests(travel_type);

CREATE INDEX idx_flight_bookings_travel_request ON flight_bookings(travel_request_id);
CREATE INDEX idx_flight_bookings_departure ON flight_bookings(departure_date);
...
CREATE INDEX idx_accommodations_checkin ON accommodations(checkin_date);
...
CREATE INDEX idx_travel_expenses_company ON travel_expenses(company_id);
...
BEGIN
  RAISE NOTICE ' ';
  RAISE NOTICE '====================================================';
  RAISE NOTICE 'TRAVEL MANAGEMENT - COMPLETE RESET SUCCESSFUL!';
  RAISE NOTICE '====================================================';
  RAISE NOTICE ' ';
  RAISE NOTICE 'Created:';
  RAISE NOTICE '  - 6 Enum Types';
  RAISE NOTICE '  - 5 Tables (fresh schema)';
  RAISE NOTICE '  - 13 RLS Policies';
  RAISE NOTICE '  - 18 Indexes';
  RAISE NOTICE '  - 5 Update Triggers';
  RAISE NOTICE ' ';
  RAISE NOTICE 'WARNING: All previous travel data was deleted!';
  RAISE NOTICE ' ';
  ...
  RAISE NOTICE '  SELECT tablename FROM pg_tables WHERE tablename LIKE travel%%';
  RAISE NOTICE ' ';
END $$;
