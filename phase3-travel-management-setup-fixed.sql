-- ============================================================================
-- WAVESYNC MARITIME PLATFORM - PHASE 3: TRAVEL MANAGEMENT SYSTEM (FIXED)
-- ============================================================================
-- This is a corrected version that handles all column and type issues
...
DO $$ BEGIN
    ...
    CREATE TYPE travel_document_type AS ENUM (
      'e_ticket', 'boarding_pass', 'hotel_confirmation', 'visa', 'insurance', 
...
DO $$ BEGIN
    ...
    CREATE TYPE expense_type AS ENUM (
      'flight', 'accommodation', 'meals', 'transportation', 'visa', 
...
CREATE TABLE IF NOT EXISTS travel_requests (
  ...
  priority VARCHAR(20) DEFAULT 'normal', -- Using VARCHAR instead of enum
...
DROP INDEX IF EXISTS idx_travel_requests_date;
DROP INDEX IF EXISTS idx_travel_requests_type;
DROP INDEX IF EXISTS idx_flight_bookings_travel_request;
DROP INDEX IF EXISTS idx_flight_bookings_departure;
DROP INDEX IF EXISTS idx_flight_bookings_status;
DROP INDEX IF EXISTS idx_accommodations_travel_request;
DROP INDEX IF EXISTS idx_accommodations_checkin;
...
DROP INDEX IF EXISTS idx_travel_expenses_company;
